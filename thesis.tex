...
% eref puts parenthesis around ref
\def\eref#1{(\ref{#1})}
...
% ***** title
%
\title{Operational Semantics for Featherweight Lua}
...
%
\newappendix{appFunction}
\newappendix{appSubstitute}
\newappendix{appGetSet}
\newappendix{appHaskell}
