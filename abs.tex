...
This thesis develops \emph{Featherweight Lua} (FWLua), following the tradition of languages like Featherweight Java\cite{FWJA} and Featherweight JavaScript\cite{FWJS}.  The goal is to develop a minimal core of language features that, while remaining simple enough for formal reasoning, also remain faithful to the central characteristics of the language.  Specifically for Lua, the core features that are essential for our modeling include:
\begin{itemize}
\item
