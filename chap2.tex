...
%FIXME: Add in an example expression that would be a valid program in JS but not in Lua.
...
\begin{array}{llr}
  ...
  \\
  %FIXME: Blocks need to be defined
...
%FIXME: Show an example of assigning multiple values to multiple variables.  In JS, I believe this is known as "destructuring assignment".  Is the same term used in Lua?
...
\end{flushleft}
% FIXED: Find a reference for prototypes
